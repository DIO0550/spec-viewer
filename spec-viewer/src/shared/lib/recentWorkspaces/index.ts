...
/**
 * @param value - Unknown entry parsed from storage
...
/**
 * @param path - Workspace path to derive a name from
...
/**
 * @param value - Stored value to inspect
