  ...
  specs: [
    {
      ...
      kind: "spec",
      sourceGroupId: "primary",
      relativeId: "040-delete-task-flow",
      presentDocumentCount: 3,
      descendantSpecCount: 0,
    ...
    sampleSpec,
    {
      ...
      kind: "spec",
      sourceGroupId: "primary",
      relativeId: "042-cache-invalidation",
      presentDocumentCount: 3,
      descendantSpecCount: 0,
    ...
    },
    {
      ...
      children: [
        {
          id: "primary/.archive/039-legacy-preview",
          label: "039-legacy-preview",
          kind: "spec",
          sourceGroupId: "primary",
          relativeId: ".archive/039-legacy-preview",
          presentDocumentCount: 3,
          descendantSpecCount: 0,
          files: sampleSpec.files,
          children: [],
    ...
    {
      id: "secondary",
      label: "agent-a1b3ff42 (.plugin-worktree)",
      kind: "sourceGroup",
