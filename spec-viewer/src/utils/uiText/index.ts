export const uiText = {
  ...
  markdown: {
    ...
    clearSearch: "文書検索をクリア",
    previousSearchMatch: "前の一致へ",
    nextSearchMatch: "次の一致へ",
    htmlZoomControls: "HTML拡大率操作",
    htmlZoomPercent: "HTML拡大率",
    decreaseHtmlZoom: "HTMLを縮小",
    increaseHtmlZoom: "HTMLを拡大",
