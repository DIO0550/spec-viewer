...
use crate::{
    ...
    infrastructure::filesystem::SpecPathResolver,
};
...
impl ReviewRunPathResolver {
    ...
    pub fn resolve(
        ...
        let spec_directory = SpecPathResolver::spec_directory_path(layout, spec_id.as_str())
            .map_err(|_| ReviewRunPathError::InvalidSpecId {
