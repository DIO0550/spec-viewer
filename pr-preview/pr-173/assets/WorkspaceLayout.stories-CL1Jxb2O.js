import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{n}from"./iframe-nISdJXV8.js";import{B as r,R as i,V as a,a as o,b as s,d as c,h as l,l as u,o as d,t as f,u as p,z as m}from"./workspace-CSMJskZd.js";import{t as h}from"./jsx-runtime-B-hFyic3.js";import{s as g,t as _}from"./MarkdownViewer-BRIwJ-ms.js";import{n as v,t as y}from"./comment-CE6my9eH.js";function b(e){let{toolbar:t,leftHeader:n,sidebar:r,tabs:i,viewer:a,comments:o,leftOpen:s,leftWidth:c,leftMinWidth:l,leftMaxWidth:d,onOpenLeft:f,onCloseLeft:p,onLeftWidthChange:m,commentsOpen:h,commentsWidth:g,commentsMinWidth:_,commentsMaxWidth:v,onOpenComments:y,onCloseComments:b,onCommentsWidthChange:x}=e,[w,T]=(0,S.useState)(s??!0),[E,D]=(0,S.useState)(c??268),[O,k]=(0,S.useState)(h??!0),[A,j]=(0,S.useState)(g??360);return(0,C.jsxs)(u.Root,{leftNavigation:{isOpen:w,width:E,minWidth:l,maxWidth:d,onOpen:()=>{T(!0),f?.()},onClose:()=>{T(!1),p?.()},onWidthChange:e=>{D(e),m?.(e)}},commentsSidebar:{isOpen:O,width:A,minWidth:_,maxWidth:v,onOpen:()=>{k(!0),y?.()},onClose:()=>{k(!1),b?.()},onWidthChange:e=>{j(e),x?.(e)}},children:[(0,C.jsx)(u.LeftNavigation,{header:n,children:r}),(0,C.jsxs)(u.Main,{children:[(0,C.jsx)(u.Toolbar,{children:t}),(0,C.jsx)(u.Tabs,{children:i}),(0,C.jsx)(u.Viewer,{children:a})]}),(0,C.jsx)(u.Comments,{children:o})]})}function x({treeState:e,documentState:t,selectedSpec:n,selectedFileKey:r,workspaceInput:s,workspaceStatusPath:c,workspaceErrorMessage:u=void 0,isWorkspaceLoading:f=!1,archivingSpecId:p=null}){let h=n?.files.find(e=>e.key===r)??null;return{leftOpen:!0,leftHeader:(0,C.jsxs)(`div`,{className:`left-navigation-brand`,children:[(0,C.jsx)(`span`,{className:`left-navigation-brand__mark`,"aria-hidden":`true`,children:`S`}),(0,C.jsxs)(`span`,{className:`left-navigation-brand__copy`,children:[(0,C.jsx)(`strong`,{children:`Spec Reviewer`}),(0,C.jsx)(`span`,{title:c??`ワークスペース未選択`,children:c??`ワークスペース未選択`})]})]}),toolbar:(0,C.jsx)(a,{children:(0,C.jsx)(o,{workspacePath:c,inputValue:s,isLoading:f,isBrowsing:!1,errorMessage:u??null,canRefresh:n!==null&&r!==null,onInputChange:w(),onBrowse:w(),onLoad:w(),onRefresh:w(),onReset:w()})}),sidebar:(0,C.jsxs)(`div`,{className:`left-navigation-panel`,children:[(0,C.jsx)(d,{currentWorkspacePath:c,isOpen:!1,isBusy:f,recentWorkspaces:[{path:T,displayName:`spec-reviewer`,kind:`plugin-workspace`,lastOpenedAt:`2026-05-06T00:00:00.000Z`},{path:`/workspace/legacy-spec-skill`,displayName:`legacy-spec-skill`,kind:`spec-skill`,lastOpenedAt:`2026-05-05T00:00:00.000Z`}],onBrowse:w(),onToggleOpen:w(),onOpenWorkspace:w(),onRemoveWorkspace:w()}),(0,C.jsx)(i,{state:e,selectedSpecId:n?.id??null,archivingSpecId:p,isLoading:p!==null,onSelectSpec:w(),onArchiveSpec:w(),onReload:w()})]}),tabs:(0,C.jsx)(m,{spec:n,selectedFileKey:r,onSelectFile:w()}),viewer:(0,C.jsx)(_,{state:t,selectedSpecLabel:n?.label??null,selectedFileLabel:h?.label??null,comments:M,activeCommentId:E(`cmt_story_open`),onReload:w(),onSelectComment:w()}),comments:(0,C.jsx)(l,{listState:{status:`ready`,comments:M,error:null},operationState:{status:`idle`,operation:null,commentId:null,error:null},activeCommentId:E(`cmt_story_open`),onSelectComment:w(),onResolveComment:w(),onReopenComment:w(),onDeleteComment:w(),onUpdateComment:w(),onReload:w()})}}var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;t((()=>{S=e(n(),1),c(),v(),r(),s(),f(),p(),C=h(),{fn:w}=__STORYBOOK_MODULE_TEST__,T=`/workspace/spec-reviewer`,E=y.fromString,D={id:`phase-1-viewer`,label:`Phase 1 Viewer`,files:[{key:`impl`,label:`Implementation`,fileName:`implementation-plan.md`,status:`missing`},{key:`tasks`,label:`Tasks`,fileName:`tasks.md`,status:`present`},{key:`tech-reference`,label:`Tech Reference`,fileName:`tech-reference.html`,status:`missing`,format:`html`},{key:`test-cases`,label:`Test Cases`,fileName:`test-cases.html`,status:`missing`,format:`html`},{key:`design`,label:`Design`,fileName:`design.md`,status:`present`}],children:[{id:`phase-1-comments`,label:`Phase 1 Comments`,files:[{key:`requirements`,label:`Requirements`,fileName:`requirements.md`,status:`present`}],children:[]}]},O={specs:[D]},k={key:`tasks`,path:`/workspace/spec-reviewer/docs/plans/tasks/phase-1-viewer/p1-13-layout-components.md`,contents:[`# P1.14 Markdown Rendering`,``,`> Render review planning documents with anchors ready for comments.`,``,`## Acceptance`,``,`- [x] Headings and lists`,`- [x] Fenced code blocks`,`- [ ] Comment behavior follows in P1.15`,``,"```ts",`const blockType = "heading";`,"```",``,`| Element | Status |`,`| --- | --- |`,`| GFM table | Ready |`,`| External link | [Docs](https://example.com/docs) |`].join(`
