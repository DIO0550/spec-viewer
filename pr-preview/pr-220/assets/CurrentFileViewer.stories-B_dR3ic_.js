import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{n}from"./iframe-BPLNAqJ2.js";import{t as r}from"./jsx-runtime-B-hFyic3.js";import{n as i,t as a}from"./DiffViewer-C1Z0Fm16.js";import{n as o,t as s}from"./CurrentFileViewer-B7P5TMxA.js";import{r as c,t as l}from"./fileDiff-DRXiGvkB.js";import{r as u,t as d}from"./testFixtures-B97CRjFJ.js";function f(){return(0,S.jsxs)(`div`,{style:{display:`grid`,gap:16},children:[(0,S.jsx)(p,{label:`Current unavailable`,children:(0,S.jsx)(s,{fileDiff:v(),revisionKey:`matrix:binary`})}),(0,S.jsx)(p,{label:`Structured diff unavailable / degraded`,children:(0,S.jsx)(s,{fileDiff:y(),revisionKey:`matrix:degraded`})}),(0,S.jsx)(p,{label:`Availability empty + non-empty current`,children:(0,S.jsx)(s,{fileDiff:d({oldContent:`available-empty-diff`,newContent:`available-empty-diff`,lines:[]}),revisionKey:`matrix:available-empty-diff`})}),(0,S.jsx)(p,{label:`Empty file`,children:(0,S.jsx)(s,{fileDiff:d({oldContent:``,newContent:``,lines:[]}),revisionKey:`matrix:empty`})}),(0,S.jsx)(p,{label:`Pure rename`,children:(0,S.jsx)(s,{fileDiff:d({status:`renamed`,oldPath:`src/old-name.ts`,newPath:`src/new-name.ts`,oldContent:`renamed-current`,newContent:`renamed-current`,lines:[]}),revisionKey:`matrix:rename`})}),(0,S.jsx)(p,{label:`Copy`,children:(0,S.jsx)(s,{fileDiff:d({status:`copied`,oldPath:`src/source.ts`,newPath:`src/copy.ts`,oldContent:`copied-current`,newContent:`copied-current`,lines:[]}),revisionKey:`matrix:copy`})}),(0,S.jsx)(p,{label:`Type changed`,children:(0,S.jsx)(s,{fileDiff:d({status:`typeChanged`,oldContent:`type-changed-current`,newContent:`type-changed-current`,lines:[]}),revisionKey:`matrix:type-changed`})})]})}function p(e){return(0,S.jsxs)(`section`,{children:[(0,S.jsx)(`h3`,{children:e.label}),e.children]})}function m(){return(0,S.jsxs)(`div`,{style:{display:`grid`,gap:16},children:[(0,S.jsxs)(`section`,{children:[(0,S.jsx)(`h3`,{children:`LF`}),(0,S.jsx)(s,{fileDiff:d({oldContent:`first
second`,newContent:`first
second`,lines:[]}),revisionKey:`endings:lf`})]}),(0,S.jsxs)(`section`,{children:[(0,S.jsx)(`h3`,{children:`CRLF`}),(0,S.jsx)(s,{fileDiff:d({oldContent:`first\r
second\r
`,newContent:`first\r
second\r
`,lines:[]}),revisionKey:`endings:crlf`})]}),(0,S.jsxs)(`section`,{children:[(0,S.jsx)(`h3`,{children:`Final newlineなし`}),(0,S.jsx)(s,{fileDiff:d({oldContent:`first\rsecond`,newContent:`first\rsecond`,lines:[]}),revisionKey:`endings:cr`})]})]})}function h(){return(0,S.jsx)(`div`,{style:{display:`grid`,gap:16},children:[{label:`Old range`,fileDiff:d({oldContent:`old`,newContent:`new`,hunks:[{header:`@@ -1 +1 @@`,lines:[{kind:`removed`,text:`old`,oldLineNumber:2,newLineNumber:null},{kind:`added`,text:`new`,oldLineNumber:null,newLineNumber:1}]}]})},{label:`New range`,fileDiff:d({oldContent:`old`,newContent:`new`,hunks:[{header:`@@ -1 +1 @@`,lines:[{kind:`removed`,text:`old`,oldLineNumber:1,newLineNumber:null},{kind:`added`,text:`new`,oldLineNumber:null,newLineNumber:2}]}]})},{label:`Hunk order`,fileDiff:d({oldContent:`old-first
old-second`,newContent:`new-first
new-second`,hunks:[l.fromLines(`@@ -2 +2 @@`,[{kind:`removed`,text:`old-second`},{kind:`added`,text:`new-second`}]),l.fromLines(`@@ -1 +1 @@`,[{kind:`removed`,text:`old-first`},{kind:`added`,text:`new-first`}])]})},{label:`Hunk overlap`,fileDiff:d({oldContent:`old`,newContent:`new`,hunks:[l.fromLines(`@@ -1 +1 @@`,[{kind:`removed`,text:`old`},{kind:`added`,text:`new`}]),l.fromLines(`@@ -1 +1 @@`,[{kind:`removed`,text:`old`},{kind:`added`,text:`new`}])]})},{label:`Old text mismatch`,fileDiff:d({oldContent:`old`,newContent:`new`,hunks:[l.fromLines(`@@ -1 +1 @@`,[{kind:`removed`,text:`different-old`},{kind:`added`,text:`new`}])]})},{label:`New text mismatch`,fileDiff:d({oldContent:`old`,newContent:`new`,hunks:[l.fromLines(`@@ -1 +1 @@`,[{kind:`removed`,text:`old`},{kind:`added`,text:`different-new`}])]})}].map(e=>(0,S.jsxs)(`section`,{children:[(0,S.jsx)(`h3`,{children:e.label}),(0,S.jsx)(s,{fileDiff:e.fileDiff,revisionKey:`invalid:${e.label}`})]},e.label))})}function g(){let[e,t]=(0,x.useState)(1),[n,r]=(0,x.useState)(`editor`);return(0,S.jsxs)(`div`,{style:{display:`grid`,height:360},children:[(0,S.jsxs)(`div`,{role:`toolbar`,"aria-label":`Story controls`,children:[(0,S.jsx)(`button`,{type:`button`,onClick:()=>r(`unified`),children:`Unified`}),(0,S.jsx)(`button`,{type:`button`,onClick:()=>r(`editor`),children:`Editor`}),(0,S.jsx)(`button`,{type:`button`,onClick:()=>t(e=>e+1),children:`Refresh`})]}),n===`editor`?(0,S.jsx)(s,{fileDiff:D,revisionKey:`workspace:snapshot-${e}:file.ts`,activeChangeId:`hunk-0-change-1`,onActiveChangeIdChange:w()}):(0,S.jsx)(a,{fileDiff:D,mode:`unified`,activeChangeId:`hunk-0-change-1`,onActiveChangeIdChange:w()})]})}function _(){let e=Array.from({length:120},(e,t)=>`current-${t+1}`);return d({oldContent:[`old-start`,...e.slice(0,60),`old-middle`,...e.slice(60),`old-eof`].join(`
`),newContent:e.join(`
`),hunks:[l.fromLines(`@@ -1 +1,0 @@`,[{kind:`removed`,text:`old-start`}]),l.fromLines(`@@ -62 +61,0 @@`,[{kind:`removed`,text:`old-middle`}]),l.fromLines(`@@ -123 +121,0 @@`,[{kind:`removed`,text:`old-eof`}])]})}function v(){let e=d({omissionReason:`binary`});return{...e,review:{...e.review,newContent:{state:`omitted`,text:null,reason:`binary`,byteLength:12}},availability:{kind:`omitted`,reason:`binary`}}}function y(){let e=d({newContent:`current
...
const second = true;`,hunks:[l.fromLines(`@@ -1,2 +0,0 @@`,[{kind:`removed`,text:`const first = true;`},{kind:`removed`,text:`const second = true;`}])]}),revisionKey:`story:deleted`,activeChangeId:`hunk-0-change-0`}},R={args:{fileDiff:d({oldContent:`x`.repeat(4e3),newContent:`x`.repeat(4e3),lines:[]}),revisionKey:`story:long-line`,activeChangeId:null},play:async({canvasElement:e})=>{let t=e.querySelector(`.current-file-viewer__scroll-surface`),n=e.querySelector(`.current-file-viewer__code`);await C(getComputedStyle(n).whiteSpace).toBe(`pre`),await C(t.scrollWidth).toBeGreaterThan(t.clientWidth),await C(e.querySelectorAll(`[role="row"]`)).toHaveLength(1)}},z={args:{fileDiff:d({oldContent:b(),newContent:b(),lines:[]}),revisionKey:`story:large`,activeChangeId:null},play:async({canvasElement:e})=>{await C(e.querySelectorAll(`[role="row"]`).length).toBeLessThanOrEqual(500),await C(E(e).getByRole(`grid`)).toHaveAttribute(`aria-rowcount`,`20000`)}},B={play:async({canvasElement:e})=>{let t=E(e).getByRole(`button`,{name:`変更前 1行`});t.focus(),await T.keyboard(`{Enter}`);let n=e.querySelector(`[data-row-kind="peek-line"]`);await C(t).toHaveAttribute(`aria-expanded`,`true`),await C(n).toHaveTextContent(`const mode = 'legacy';`),await C(n).toHaveAttribute(`data-commentable`,`false`)}},V={render:()=>(0,S.jsx)(f,{}),play:async({canvasElement:e})=>{let t=E(e);await C(t.getByRole(`heading`,{name:`Current unavailable`})).toBeInTheDocument(),await C(t.getByRole(`heading`,{name:`Structured diff unavailable / degraded`})).toBeInTheDocument(),await C(t.getByRole(`heading`,{name:`Pure rename`})).toBeInTheDocument(),await C(t.getByRole(`heading`,{name:`Copy`})).toBeInTheDocument(),await C(t.getByRole(`heading`,{name:`Type changed`})).toBeInTheDocument()}},H={render:()=>(0,S.jsx)(m,{})},U={render:()=>(0,S.jsx)(h,{}),play:async({canvasElement:e})=>{await C(E(e).getAllByRole(`alert`)).toHaveLength(6)}},W={render:()=>(0,S.jsx)(g,{}),play:async({canvasElement:e})=>{let t=E(e),n=t.getByRole(`button`,{name:`変更前 1行`});await T.click(n),await C(n).toHaveAttribute(`aria-expanded`,`true`),await T.click(t.getByRole(`button`,{name:`Refresh`})),await C(t.getByRole(`button`,{name:`変更前 1行`})).toHaveAttribute(`aria-expanded`,`false`),await T.click(t.getByRole(`button`,{name:`Unified`})),await C(t.getByLabelText(/の差分$/)).toBeInTheDocument(),await T.click(t.getByRole(`button`,{name:`Editor`})),await C(t.getByLabelText(/のcurrent内容$/)).toBeInTheDocument()}},G={globals:{theme:`Dark`}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{}`,...A.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    const canvas = within(canvasElement);
    const peek = canvas.getByRole("button", {
      name: "変更前 1行"
    });
...
}`,...G.parameters?.docs?.source}}},K=[`Default`,`AllProps`,`EdgeCases`,`Empty`,`Degraded`,`Error`,`AddedOrUntracked`,`Deleted`,`LongSingleLine`,`LargeLineCount`,`KeyboardPeek`,`AvailabilityMatrix`,`LineEndings`,`InvalidHunks`,`WorkspaceRefreshAndMode`,`DarkTheme`]}))();export{I as AddedOrUntracked,j as AllProps,V as AvailabilityMatrix,G as DarkTheme,A as Default,P as Degraded,L as Deleted,M as EdgeCases,N as Empty,F as Error,U as InvalidHunks,B as KeyboardPeek,z as LargeLineCount,H as LineEndings,R as LongSingleLine,W as WorkspaceRefreshAndMode,K as __namedExportsOrder,k as default};