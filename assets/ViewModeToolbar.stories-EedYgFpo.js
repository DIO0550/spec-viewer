import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-BpX3lQ6F.js";import{n,t as r}from"./ViewModeToolbar-CvkNZfyb.js";var i,a,o,s,c,l,u,d,f,p;e((()=>{n(),i=t(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={component:r,args:{mode:`specs`,activeItemLabel:`Implementation`,onModeChange:a()},argTypes:{mode:{control:`inline-radio`,options:[`specs`,`diff`]},onModeChange:{control:!1}},decorators:[e=>(0,i.jsx)(`div`,{style:{maxWidth:900},children:(0,i.jsx)(e,{})})]},s={},c={args:{mode:`diff`}},l={args:{activeItemLabel:`とても長いファイル名でもツールバー全体が崩れないことを確認するための仕様書.md`}},u={args:{diffAvailability:{status:`ready`}}},d={args:{diffAvailability:{status:`unavailable`,reason:`Git repositoryではありません`}}},f={args:{diffAvailability:{status:`unavailable`,reason:`Diff情報を読み込んでいます`}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{}`,...s.parameters?.docs?.source}}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    mode: "diff"
  }
